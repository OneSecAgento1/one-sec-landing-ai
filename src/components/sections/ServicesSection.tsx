...
const ServicesSection = () => {
  ...
  return <section ref={sectionRef} id="services" className="py-24 pt-0 bg-gradient-to-b from-onesec-dark/95 to-onesec-dark/90 relative -mt-24">
      ...
      <div className="absolute inset-0 opacity-20">
        {[...Array(12)].map((_, i) => <div key={i} className="absolute w-32 h-32 lg:w-48 lg:h-48 rounded-full animate-pulse-light-enhanced parallax-bg-item" style={{

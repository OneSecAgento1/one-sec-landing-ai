  ...
  return (
    <section ref={sectionRef} className="relative min-h-screen pt-24 pb-48 flex items-center bg-onesec-dark overflow-hidden">
      ...
      <div className="container mx-auto relative z-10 px-4">
        <div className="lg:max-w-4xl mx-auto text-center mb-12">
          ...
          <div className="flex flex-col sm:flex-row justify-center gap-4 animate-on-scroll opacity-0 animate-slide-up-delay-3 relative z-30">
            <Button 
              size="lg" 
              className="bg-onesec-accent hover:bg-onesec-accent/90 text-white font-medium text-base px-8 py-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-lg cursor-pointer relative z-30"
            ...
            <Button 
              size="lg" 
              className="bg-[#2c2c3a] border border-[#4f8cff] text-white hover:bg-[#2c2c3a]/90 hover:border-[#4f8cff]/90 font-medium rounded-[6px] px-8 py-6 transition-all duration-300 hover:-translate-y-1 hover:shadow-glow-blue cursor-pointer relative z-30"
      ...
      <div className="absolute bottom-12 left-1/2 transform -translate-x-1/2 z-20 animate-bounce-slow pointer-events-none">
        <button 
          onClick={scrollToServices} 
          className="flex flex-col items-center text-white/70 hover:text-white transition-colors cursor-pointer pointer-events-auto"

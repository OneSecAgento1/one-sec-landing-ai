...
const AboutSection = () => {
  ...
  return <section id="about" className="py-24 bg-gradient-to-b from-onesec-dark/90 to-onesec-dark relative">
      ...
      <div className="decorative-shape shape-blob bg-onesec-secondary/10 w-52 h-52 bottom-1/4 -right-20 animate-float pointer-events-none" style={{
      animationDelay: '1.5s'
    }}></div>
      ...
      <div className="container mx-auto px-4 relative z-20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 relative z-20">
          {pillars.map((pillar, index) => <div key={pillar.id} className="bg-white/5 backdrop-blur-sm p-8 rounded-xl border border-white/10 
        ...
        <div className="mt-24 bg-white/5 backdrop-blur-xl rounded-2xl p-10 max-w-4xl mx-auto text-center border border-white/15 opacity-0 animate-fade-in relative z-20" style={{
        animationDelay: "0.7s"
      }}>
          ...
          <p className="text-gray-300 mb-8 select-text">Let's talk. 30 minutes to see if we're a match.</p>
          <Button size="lg" className="bg-onesec-primary hover:bg-onesec-primary/90 text-white px-8 py-6 text-lg transition-all duration-300 hover:-translate-y-1 hover:shadow-glow-blue pointer-events-auto cursor-pointer select-none relative z-30" onClick={scrollToContact} type="button">
